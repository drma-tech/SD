...
namespace SD.WEB.Core
{
    public abstract class ApiCore<T>
    {
        ...
        protected ApiCore(IHttpClientFactory httpClientFactory, IMemoryCache memoryCache, object cacheKey, bool externalLink = false)
        {
            _http = httpClientFactory.CreateClient("RetryHttpClient");
            _cache = memoryCache;
