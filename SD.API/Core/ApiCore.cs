...
public static class ApiCore
{
    ...
    public static async Task AddTmdbListItem(this HttpClient http, int listId, int tmdbId, MediaType type,
        string? token, CancellationToken cancellationToken)
    {
        ...
        var obj = new
            { items = new[] { new { media_type = type == MediaType.movie ? "movie" : "tv", media_id = tmdbId } } };
    ...
    public static async Task<T?> GetReviewsByImdb8<T>(this HttpClient http, string? tconst,
        CancellationToken cancellationToken) where T : class
    {
    ...
    public static async Task<T?> GetFilmShowRatings<T>(this HttpClient http, string? imdbId,
        CancellationToken cancellationToken) where T : class
    {
