namespace SD.Shared.Models.List.Tmdb
{
    ...
    public class MediaProviders
    {
        ...
        public List<ProviderBase> GetFreeListProviders(Region region)
        {
            ...
            return region switch
            {
                Region.AE => results.AE?.free.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.CI => results.CI?.free.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.HK => results.HK?.free.Cast<ProviderBase>().ToList() ?? new(),
                Region.HR => results.HR?.free.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.KE => results.KE?.free.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.RS => results.RS?.free.Cast<ProviderBase>().ToList() ?? new(),
                Region.RU => results.RU?.free.Cast<ProviderBase>().ToList() ?? new(),
                Region.SE => results.SE?.free.Cast<ProviderBase>().ToList() ?? new(),
                Region.SK => results.SK?.free.Cast<ProviderBase>().ToList() ?? new(),
        ...
        public IEnumerable<ProviderBase> GetAdsListProviders(Region region)
        {
            ...
            return region switch
            {
                Region.AE => results.AE?.ads.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.CI => results.CI?.ads.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.HK => results.HK?.ads.Cast<ProviderBase>().ToList() ?? new(),
                Region.HR => results.HR?.ads.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.KE => results.KE?.ads.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.RS => results.RS?.ads.Cast<ProviderBase>().ToList() ?? new(),
                Region.RU => results.RU?.ads.Cast<ProviderBase>().ToList() ?? new(),
                Region.SE => results.SE?.ads.Cast<ProviderBase>().ToList() ?? new(),
                Region.SK => results.SK?.ads.Cast<ProviderBase>().ToList() ?? new(),
        ...
        public IEnumerable<ProviderBase> GetFlatRateListProviders(Region region)
        {
            ...
            return region switch
            {
                Region.AE => results.AE?.flatrate.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.CI => results.CI?.flatrate.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.HK => results.HK?.flatrate.Cast<ProviderBase>().ToList() ?? new(),
                Region.HR => results.HR?.flatrate.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.KE => results.KE?.flatrate.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.RS => results.RS?.flatrate.Cast<ProviderBase>().ToList() ?? new(),
                Region.RU => results.RU?.flatrate.Cast<ProviderBase>().ToList() ?? new(),
                Region.SE => results.SE?.flatrate.Cast<ProviderBase>().ToList() ?? new(),
                Region.SK => results.SK?.flatrate.Cast<ProviderBase>().ToList() ?? new(),
        ...
        public IEnumerable<ProviderBase> GetFlatRateBuyListProviders(Region region)
        {
            ...
            return region switch
            {
                Region.AE => results.AE?.flatrate_and_buy.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.CI => results.CI?.flatrate_and_buy.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.HK => results.HK?.flatrate_and_buy.Cast<ProviderBase>().ToList() ?? new(),
                Region.HR => results.HR?.flatrate_and_buy.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.KE => results.KE?.flatrate_and_buy.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.RS => results.RS?.flatrate_and_buy.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.SK => results.SK?.flatrate_and_buy.Cast<ProviderBase>().ToList() ?? new(),
        ...
        public IEnumerable<ProviderBase> GetRentListProviders(Region region)
        {
            ...
            return region switch
            {
                Region.AE => results.AE?.rent.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.CI => results.CI?.rent.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.HK => results.HK?.rent.Cast<ProviderBase>().ToList() ?? new(),
                Region.HR => results.HR?.rent.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.KE => results.KE?.rent.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.RS => results.RS?.rent.Cast<ProviderBase>().ToList() ?? new(),
                Region.RU => results.RU?.rent.Cast<ProviderBase>().ToList() ?? new(),
                Region.SE => results.SE?.rent.Cast<ProviderBase>().ToList() ?? new(),
                Region.SK => results.SK?.rent.Cast<ProviderBase>().ToList() ?? new(),
        ...
        public IEnumerable<ProviderBase> GetBuyListProviders(Region region)
        {
            ...
            return region switch
            {
                Region.AE => results.AE?.buy.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.CI => results.CI?.buy.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.HK => results.HK?.buy.Cast<ProviderBase>().ToList() ?? new(),
                Region.HR => results.HR?.buy.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.KE => results.KE?.buy.Cast<ProviderBase>().ToList() ?? new(),
                ...
                Region.RS => results.RS?.buy.Cast<ProviderBase>().ToList() ?? new(),
                Region.RU => results.RU?.buy.Cast<ProviderBase>().ToList() ?? new(),
                Region.SE => results.SE?.buy.Cast<ProviderBase>().ToList() ?? new(),
                Region.SK => results.SK?.buy.Cast<ProviderBase>().ToList() ?? new(),
